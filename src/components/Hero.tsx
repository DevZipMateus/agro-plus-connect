          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-white text-sm font-medium">Desde 2022 no campo</span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <p className="text-white/80 text-sm">Trabalhamos apenas com marcas de confiança</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                <Users className="h-12 w-12 text-accent mx-auto mb-4" />
                <h3 className="text-white font-semibold text-lg mb-2">Atendimento Personalizado</h3>
                <p className="text-white/80 text-sm">Cada cliente é tratado com atenção e cuidado</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center sm:col-span-2">
                <Leaf className="h-12 w-12 text-accent mx-auto mb-4" />
                <h3 className="text-white font-semibold text-lg mb-2">Sustentabilidade</h3>
                <p className="text-white/80 text-sm">Incentivamos práticas que preservem o meio ambiente</p>
              </div>
            </div>
          </div>
        </div>
